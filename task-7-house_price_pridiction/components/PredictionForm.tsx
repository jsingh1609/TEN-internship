    ...
    <Card className="w-full max-w-md mx-auto glassmorphism">
      <CardHeader>
        <div className="flex items-center gap-3">
          ...
          <div>
            <CardTitle className="text-2xl">House Price Predictor</CardTitle>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid gap-3">
            <div className="flex justify-between items-center">
              ...
              <span className="text-sm font-semibold w-8 text-center py-1 px-2 rounded-md bg-muted text-muted-foreground">{bedrooms[0]}</span>
            </div>
          ...
          <div className="grid gap-3">
            <div className="flex justify-between items-center">
              ...
              <span className="text-sm font-semibold w-8 text-center py-1 px-2 rounded-md bg-muted text-muted-foreground">{bathrooms[0]}</span>
            </div>
          ...
          <AnimatePresence>
            {predictedPrice !== null && (
              ...
              >
                ...
                <p className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-purple-400">
