...
export default function ProfileView({ userProfile, onOpenEdit }) {
  ...
  return (
    <div className="w-full max-w-[935px] mx-auto animate-slide-up-fade pb-20">
      ...
      <div className="flex justify-center gap-12 border-b border-neutral-800">
        <button className="py-3 px-2 border-t-2 border-white text-sm font-semibold flex items-center gap-2">
          <Grid className="w-4 h-4" /> POSTS
        </button>
        <button className="py-3 px-2 text-neutral-500 text-sm font-semibold flex items-center gap-2 hover:text-neutral-300 transition-colors">
